...
<article class="page-container">
	...
	<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>项目属别：</label>
	...
	<div class="row cl">
			...
			<div class="formControls col-xs-6 col-sm-3"> <span class="select-box">
				<select name="" class="select">
					<option value="0">国家级XXX</option>
					<option value="1">省部级XXXX</option>
					<option value="11">市厅级XXX</option>	
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-3 col-sm-3">
				<input type="text" class="input-text radius size-S" value="0" placeholder="" id="" name="">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">项目凭证：</label>
