			...
			<div class="row cl">
				...
				<div class="formControls col-xs-3 col-sm-4">
					<input type="text" class="input-text radius size-S"
						...
						placeholder="" id="" name="projectinfo_l">
						<input type="hidden" class="input-text radius size-S" value="${sessionScope.user.user_Id}"
						readonly="true"  placeholder="" id="" name="projectinfo_Leader">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
				...
				<div class="formControls col-xs-3 col-sm-4">
					<input type="text" class="input-text radius size-S" value=""
						placeholder="" id="" name="projectinfo_Name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
				...
				<div class="formControls col-xs-8 col-sm-3">
					<span class="select-box"> <select name="paperinfo_sort"
						class="select">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-4">
					<input type="text"
						...
						id="datemin" class="input-text Wdate" name="projectinfo_StartTime">
				</div>
								<label class="form-label col-xs-4 col-sm-2"><span
				...
				<div class="formControls col-xs-8 col-sm-4">
					<input type="text"
						onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})"
						id="datemin" class="input-text Wdate" name="projectinfo_FinishTime">
			</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
				...
				<div class="formControls col-xs-8 col-sm-4">
					<input type="text" class="input-text" value="" placeholder="上限为200万" id=""
