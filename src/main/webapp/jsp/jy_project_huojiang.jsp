...
<body>
	...
	<form class="form form-horizontal" id="" action="${pageContext.request.contextPath}/jy_project/Add_HuoJiang.do" method="post">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span
				class="c-red">*</span>颁奖机构名称：</label>
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text radius size-S" name="organize_name" >
			</div>
			
		</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>颁奖时间：</label> 
