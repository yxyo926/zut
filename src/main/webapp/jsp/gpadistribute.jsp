			...
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					...
					<input type="text" class="input-text" name="userteam_name"
					 id="useteam_name" disabled="disabled" value="${sessionScope.Userteam.userteam_name}">
					</div>
			<label class="form-label col-xs-4 col-sm-2"><span
	    ...
	    function addText(){
	        ...
	        for(var i=0;i<count-1;i++){
	        	div.innerHTML += "<div class='row cl'> <label class='form-label col-xs-3 col-sm-2'>"
	    	        ...
	    	        +"<div class='formControls col-xs-3 col-sm-2'>"
	    	        +"<input type='text' class='input-text radius size-S' value='2' placeholder='' id='getGpa"+i+"' name='paperinfo_Name'>";
	        }
