	...
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-list-container" style="width: 300xp;height: 200px;"> 
					<div class="queueList" style="width: 300xp;height: 200px">
						<div id="dndArea" class="placeholder" style=" padding-top:0px;">
