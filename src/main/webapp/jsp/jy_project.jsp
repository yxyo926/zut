	...
	<form class="form form-horizontal" id="">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<span class="select-box"> <select id="select_category" class="select"  onchange="FandLevByid()">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-3">
				<input type="text" class="input-text radius size-S" id="project_name" >
			</div>
		...
		<label class="form-label col-xs-4 col-sm-2"><span
			...
			<div class="formControls col-xs-6 col-sm-3">
				...
				<select id="lev_select" class="select">
					<option value="">---请选择---</option>
				</select>
				</span>
			</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button	class="btn btn-primary radius" type="button" onclick="Tijiao()">下一步</button>
...
$(function (){
	$("#buzou2").click(function (){
		window.location.href="${pageContext.request.contextPath}/jsp/jiaoyan/gpa.jsp"
	})
	
})
//根据项目类型，变换项目级别
function FandLevByid(){
	var category_id = document.getElementById("select_category").value;
	/* alert(id); */
	var data={
			category_id:category_id
	}
	document.getElementById("lev_select").innerHTML="";
	$.ajax({
	      ...
	      success : function(result) {
		              ...
		              for (var i = 0; i < result.length; i++) {
							...
							opt.value = result[i].project_id;
							opt.innerHTML = result[i].projectlev_name;
							select2.append(opt);
						}
		            }
		     });
