	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="javascript:;" onclick="datadel()"
				...
				onclick="location.href='${pageContext.request.contextPath}/wenyi/FindAll_lev.do'"><i
			...
			<table
				...
				<thead>
					<tr class="text-c">
						...
						<th width="auto">作品名称</th>
						<th width="auto">作品类别</th>
						<th width="auto">作品级别</th>
						<th width="auto">中原工学院署名</th>
				...
				<tbody>
					<c:forEach items="${projectList}" var="wy_chuban">
						<tr>
							...
							<td>${wy_chuban.project_id }</td>
							<td>${wy_chuban.project_name}</td>
							<td>${wy_chuban.project_type}</td>
							<td>${wy_chuban.lev_select}</td>
							<td>${wy_chuban.wy_zutsign}</td>
							<td class="text-center">${wy_chuban.press_name}</td>
							<td class="text-center">${wy_chuban.qk_name}</td>
							<td class="text-center">${wy_chuban.cb_time}</td>
