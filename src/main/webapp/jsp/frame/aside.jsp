	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">		
			...
			<dl id="menu-picture">
				...
				<dd>
					<ul>
						<li><a data-href="${pageContext.request.contextPath}/jy_project/Jiaogai_findAllById.do?id=${sessionScope.user.user_Id}" data-title="教改项目管理">教改项目管理</a></li>
						<li><a data-href="${pageContext.request.contextPath}/jy_project/Zhuanye_findAllById.do?id=${sessionScope.user.user_Id}" data-title="专业项目管理">专业项目管理</a></li>
						<li><a data-href="${pageContext.request.contextPath}/jy_project/Kecheng_findAllById.do?id=${sessionScope.user.user_Id}" data-title="课程项目管理">课程项目管理</a></li>
						<li><a data-href="${pageContext.request.contextPath}/jy_project/Huojiang_findAllById.do?id=${sessionScope.user.user_Id}" data-title="获奖项目管理">获奖项目管理</a></li>
						<li><a data-href="${pageContext.request.contextPath}/jy_book/book_findAllById.do?id=${sessionScope.user.user_Id}" data-title="教材业绩管理">教材项目管理</a></li>
						<li><a data-href="${pageContext.request.contextPath}/jy_project/lunwen_findAllById.do?id=${sessionScope.user.user_Id}" data-title="论文业绩录入">教研论文业绩管理</a></li>
						<li><a data-href="${pageContext.request.contextPath}/jy_pingtai/pingtai_findAllById.do?id=${sessionScope.user.user_Id}" data-title="教研平台业绩申报">教研平台业绩管理</a></li>
					</ul>
				</dd>
			</dl>
			<dl >
			...
			<dd>
				<ul>
					<li><a data-href="${pageContext.request.contextPath}/wenyi/chuban_findAllById.do?id=${sessionScope.user.user_Id}" data-title="作品出版和发表申报">作品出版和发表申报</a></li>
					<li><a data-href="${pageContext.request.contextPath}/wenyi/biaoyan_findAllById.do?id=${sessionScope.user.user_Id}" data-title="艺术展览与文艺演出业绩申报">艺术展览与演出业绩申报</a></li>
