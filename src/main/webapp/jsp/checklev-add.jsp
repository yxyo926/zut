...
<body onload="bangnum(this)">
	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-paper-add"
			action="${pageContext.request.contextPath}/plateform/save.do"
			method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
					class="c-red">*</span>信息编号：</label>
				<div class="formControls col-xs-8 col-sm-4">
					<input type="text" class="input-text" value="${plateform.plateforminfo_id}" placeholder=""
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-3 col-sm-4">
					<input type="text" class="input-text radius size-S" value=""
						placeholder="" readonly="true" id="" name="plateforminfo_name">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2"><span
				...
				<div class="formControls col-xs-6 col-sm-4">
					<span class="select-box"> <select name="plateforninfo_checklev"
						class="select">
							<c:forEach items="${dictRatios}" var="para">
								<option value="${para.dictratio_id}">${para.dictratio_lev}</option>
							</c:forEach>
					</select>
					</span>
				</div>
