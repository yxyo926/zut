					...
					<tr>
						...
						<td class="text-center"><c:if
								...
								<button type="button" href="javascript:;"
									onclick="info_edit('编辑','updateInfo.do?id=${paper.paperinfo_Id}','4','','510')"
							...
							<button type="button"
								...
								class="btn bg-olive btn-xs">详情</button></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
